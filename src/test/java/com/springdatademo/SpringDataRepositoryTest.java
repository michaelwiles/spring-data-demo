...
import com.springdatademo.dao.springdata.SpringDataEmployeeRepository;
...
public class SpringDataRepositoryTest {
    ...
    public void testFindBySurname() {
        ...
        List<Employee> findBySurname = employeeRepository.findBySurname("smith");
    ...
    public void testFindByTeam() {
        ...
        List<Employee> findByTeam = employeeRepository.findByTeamsName("new business");
